...
import com.webnation.begonerobotexters.widgets.SlidingTabLayout.TabColorizer
 ...
 */
internal class SlidingTabStrip private constructor(
    context: Context,
    attrs: AttributeSet?
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        if (childCount > 0) {
            ...
            if (mSelectionOffset > 0f && mSelectedPosition < getChildCount() - 1) {
                ...
                if (color != nextColor) {
                    color =
                        blendColors(nextColor, color, mSelectionOffset)
                }
    ...
    private class SimpleTabColorizer : TabColorizer {
        private var mIndicatorColors = intArrayOf()
    ...
    companion object {
        ...
        private fun blendColors(color1: Int, color2: Int, ratio: Float): Int {
            ...
            val r =
                Color.red(color1) * ratio + Color.red(color2) * inverseRation
            val g =
                Color.green(color1) * ratio + Color.green(
                    color2
                ) * inverseRation
            val b =
